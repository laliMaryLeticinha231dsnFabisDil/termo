...
//PALAVRAS DO JOGO
let palavras = ['LINDA', 'CASAR', 'JULHO', 'NOITE', 'BANDO']
...
backspaceBotao.style.width = "20vh";
backspaceBotao.style.color = "white";
...
enterBotao.style.width = "20vh";
enterBotao.style.color = "white";
